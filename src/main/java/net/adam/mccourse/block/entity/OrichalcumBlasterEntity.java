package net.adam.mccourse.block.entity;

import net.fabricmc.fabric.api.registry.FuelRegistry;
import net.adam.mccourse.item.ModItems;
import net.adam.mccourse.item.inventory.ImplementedInventory;
import net.adam.mccourse.recipe.OrichalcumBlasterRecipe;
import net.adam.mccourse.screen.OrichalcumBlasterScreenHandler;
