package net.adam.mccourse.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.adam.mccourse.MCCourseMod;
import net.adam.mccourse.block.custom.*;
import net.adam.mccourse.fluid.ModFluids;
import net.adam.mccourse.item.ModItemGroups;
import net.adam.mccourse.sound.ModSounds;
import net.adam.mccourse.world.feature.tree.CherryBlossomSaplingGenerator;
